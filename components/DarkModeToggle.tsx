  ...
  return (
    <div className="inline-flex items-center space-x-3 sm:absolute top-0 right-0">
      ...
      <div className="relative h-8 transition duration-200 ease-in">
        <label htmlFor="toggleDarkMode" className="cursor-pointer inline-flex relative">
          <input
            id="toggleDarkMode"
            type="checkbox"
          ...
          />
          <span
            className="w-16 h-8 bg-white rounded-full shadow-inner block"
            style={{ backgroundColor: theme === Theme.LIGHT ? 'rgba(0, 0, 0, 0.54)' : '#5600D7' }}
          />
          <span
            className="translate-x-[3px] translate-y-[4px] peer-checked:translate-x-9 transform-gpu absolute w-6 h-6 bg-white rounded-full"
