    ...
    <Layout home description="@fahrulalwan 's personal website">
      ...
      <section className="text-xl bg-white dark:bg-github p-5 rounded-xl mt-3 dark:text-white space-y-3">
        <p>
          ...
          in Front-end) at Jatis & . I&apos;m just like another human, I like to search good stuff
          on the internet. But often neighbours ask me to do work I dont know about, like electrical
          & mechanical stuff.
        </p>
        <p>
          I can also considered as digital magician, I can turn coffee into automated script, even
          software (p.s. i can&apos;t make money, yet). I love to learn pretty much anything
          (including outside the dev world!). I also into philosophical stuff. I often challenge my
          mind to question stuff coming into my mind.
        </p>
        <p className="space-x-4 text-center">
          ...
          <a
            target="_blank"
            href="https://www.linkedin.com/in/mohammad-fahrul-alwan-50652a125"
            rel="noopener noreferrer">
            <svg
              className="inline-flex opacity-60 hover:opacity-100 dark:text-white"
              width={30}
          ...
          <a rel="noopener noreferrer" target="_blank" href="mailto:fahrulalwan@gmail.com">
            <svg
              className="inline-flex opacity-60 hover:opacity-100 dark:text-white"
              width={44}
              height={44}
      ...
      <section className="leading-normal pt-px px-5 mt-5">
        <h2 className="text-3xl leading-relaxed my-4 dark:text-white">Blog</h2>
        <motion.ul
          initial="closed"
          animate="open"
          className="space-y-5"
          ...
          {allPostsData.map(({ id, date, title }) => (
            <motion.li
              ...
              <Link href="/posts/[id]" as={`/posts/${id}`}>
                <a className="text-blue-600 dark:text-purple-200 text-xl">{title}</a>
              </Link>
              <br />
