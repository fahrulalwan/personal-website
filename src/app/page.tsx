  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <p className="text-xl mb-8">Senior Frontend Engineer & Tech Lead</p>
        <div className="flex space-x-4 mb-12">
          <Button variant="outline" size="icon" asChild>
            <Link href="https://github.com/fahrulalwan" target="_blank" rel="noopener noreferrer">
              <Github className="h-5 w-5" />
              <span className="sr-only">GitHub</span>
            </Link>
          </Button>
          <Button variant="outline" size="icon" asChild>
            <Link href="https://linkedin.com/in/fahrulalwan" target="_blank" rel="noopener noreferrer">
        ...
        <div className="max-w-2xl mb-12">
          <p className="text-lg mb-4">
            With 7 years of experience in the tech industry and a Summa Cum Laude degree in Information Systems, 
            I specialize in creating robust and scalable web applications using modern JavaScript frameworks.
          </p>
          <p className="text-lg">
            I&apos;m passionate about solving complex problems and driving business impact through innovative technology solutions.
          </p>
        </div>
